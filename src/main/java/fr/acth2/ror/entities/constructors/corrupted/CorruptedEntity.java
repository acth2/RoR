package fr.acth2.ror.entities.constructors.corrupted;
...
public class CorruptedEntity extends MonsterEntity {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSoundEvents.CORRUPTED_AMBIENT.get();
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource p_184601_1_) {
        return ModSoundEvents.CORRUPTED_HIT.get();
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSoundEvents.CORRUPTED_DIE.get();
    }
