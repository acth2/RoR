package fr.acth2.ror.entities.entity.rift;
...
public class EntityRiftV2 extends RiftV2Entity implements IAnimatable {

    private final AnimationFactory factory = new AnimationFactory(this);

    public EntityRiftV2(EntityType<? extends RiftV2Entity
            > type, World worldIn) {
        super(type, worldIn);
    }
