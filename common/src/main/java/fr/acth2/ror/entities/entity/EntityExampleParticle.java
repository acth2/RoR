...
public class EntityExampleParticle extends ExampleParticleEntity implements IAnimatable {

    private final AnimationFactory factory = new AnimationFactory(this);

    public EntityExampleParticle(EntityType<? extends ExampleParticleEntity
            > type, World worldIn) {
        super(type, worldIn);
    }
