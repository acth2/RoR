...
public class BuffsSpawnSubscriber {

    public static int SPAWN_INTERVAL_TICKS = 12000;
    public static int ATTEMPTS_PER_PLAYER = 2;
    public static double SPAWN_CHANCE = 2.45;
