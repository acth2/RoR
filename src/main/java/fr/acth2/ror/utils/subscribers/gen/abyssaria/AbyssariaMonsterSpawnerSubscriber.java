package fr.acth2.ror.utils.subscribers.gen.abyssaria;
...
public class AbyssariaMonsterSpawnerSubscriber {
    ...
    public static void onWorldTick(WorldTickEvent event) {
        ...
        if (!serverWorld.dimension().location().toString().equals(References.MODID + ":abyssaria")) {
            return;
        }
