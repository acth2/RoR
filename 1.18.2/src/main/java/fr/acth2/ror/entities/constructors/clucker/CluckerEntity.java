...
public class CluckerEntity extends Monster {

    public CluckerEntity(EntityType<? extends Monster> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public boolean doHurtTarget(Entity target) {
        ...
        if (flag && target instanceof LivingEntity) {
            ((LivingEntity) target).addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 75, 3));
        }
        return flag;
    }
