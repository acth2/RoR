...
public class RareCaveMonsterSpawnerSubscriber {

    private static final int SPAWN_INTERVAL_TICKS = 500;
    private static final int ATTEMPTS_PER_PLAYER = 2;
    private static final double SPAWN_CHANCE = 1.75;
    ...
    private static void trySpawnCaveMonsterNearPlayer(ServerWorld world, Player player) {
